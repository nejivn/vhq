document.addEventListener("DOMContentLoaded", async () => {
    ...
    async function saveScore() {
        ...
        try {
            const res = await fetch("https://vhq.onrender.com/save-score", {
                method: "POST",
                headers: {
    ...
    async function fetchHistory() {
        try {
            const res = await fetch("https://vhq.onrender.com/history", {
    ...
    async function fetchCompetitions() {
        try {
            const res = await fetch("https://vhq.onrender.com/competitions", {
    ...
    async function loadCompetition(competitionId) {
        try {
            const res = await fetch(`https://vhq.onrender.com/competitions/${competitionId}/questions`, {
                headers: { Authorization: token }
            });
